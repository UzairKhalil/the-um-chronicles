...
const PATHS = {
  ...
  music:
    'M8.5 18a2.5 2.5 0 1 1-2.5-2.5A2.5 2.5 0 0 1 8.5 18ZM8.5 18V6.5l10-2.5v11.5M18.5 15.5A2.5 2.5 0 1 1 16 13a2.5 2.5 0 0 1 2.5 2.5ZM8.5 10l10-2.5',
  musicOff:
    'M8.5 18a2.5 2.5 0 1 1-2.5-2.5A2.5 2.5 0 0 1 8.5 18ZM8.5 18V6.5l10-2.5v11.5M18.5 15.5A2.5 2.5 0 1 1 16 13a2.5 2.5 0 0 1 2.5 2.5ZM4 4l16 16',
}
